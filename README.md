...
The simulation outputted a set of supernova neutrino event images and images comprised only of noise. A convolutional neural network was used to investigate classification accuracy under a range of different conditions. 
